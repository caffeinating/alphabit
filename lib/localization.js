...
var _alphabit = require("alphabit");
...
var lang = _alphabit.T.left(window.navigator.userLanguage || window.navigator.language, 2);
...
function lbl(fieldName) {
    ...
    return result || _alphabit.T.camelCaseToTitleCase(fieldName);
}
